...
public class MagicConnectionCreationTool extends ConnectionCreationTool {
    ...
    private void addElementActions(Menu menu, String menuText, IDiagramModelArchimateComponent sourceDiagramModelComponent, EClass[] list) {
        ...
        for(EClass type : list) {
            ...
            for(EClass typeRel : ArchimateModelUtils.getRelationsClasses()) {
                ...
                if(ArchimateModelUtils.isValidRelationship(sourceConcept, targetConcept, typeRel)) {
    ...
    private void addConnectionActions(Menu menu, IArchimateConcept sourceConcept, IArchimateConcept targetConcept) {
        ...
        for(EClass type : ArchimateModelUtils.getValidRelationships(sourceConcept.eClass(), targetConcept.eClass())) {
            if(ArchimateModelUtils.isValidRelationship(sourceConcept, targetConcept, type)) {
        ...
        for(EClass type : ArchimateModelUtils.getValidRelationships(targetConcept.eClass(), sourceConcept.eClass())) {
            if(ArchimateModelUtils.isValidRelationship(sourceConcept, targetConcept, type)) {
